...
export default () => (
  <Container>
    <Container text id="bio" className={document.getElementById("bg-button").firstChild && window.getComputedStyle(document.getElementById("bg-button")).opacity==1?"raised":""}>
    <Image src="/headshot.jpg" size='medium' floated='right' circular className='headshot'/>
      ...
      <p>
        Currently, I'm a member of the <a href="https://hackmit.org/">HackMIT</a> dev team, and I've been working on some of our <a href="https://code.hackmit.org/">apps</a>, including our new registration platform feather and our submission platform, spectacle.
      </p>
